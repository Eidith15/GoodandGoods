        ...
        <div class="ht__bradcaump__area" style="background: rgba(0, 0, 0, 0) url(<?= base_url(); ?>assets/images/about/about.jpg) no-repeat scroll center center / cover ;">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="section__title section__title--2 text-center">
                            <h2 class="title__line">Welcome To Good & Goods Book Store</h2>
                ...
                <div class="row">
                    <div class="col">
                        <div class="htc__choose__wrap bg__cat--4">
                            <div class="container">
                            <h2 class="choose__title text-center">Why Choose Us?</h2>
                    ...
                    <div class="col-md-4 col-lg-4 col-sm-12">
                        <div class="team foo">
                            <div class="team__thumb">
                                <a href="#">
                                    <img src="<?= base_url(); ?>assets/images/team/1.jpg" alt="team images">
                                </a>
                            </div>
