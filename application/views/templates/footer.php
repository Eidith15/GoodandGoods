            ...
            <div class="col-md-6 col-lg-3 col-sm-6">
                <div class="ft__widget">
                    ...
                    <div class="footer__details">
                        <p>We Sell Goods that Good to you to enjoy.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-3 col-sm-6 smt-30 xmt-30">
                <div class="ft__widget contact__us">
                    ...
                    <div class="footer__inner">
                        <p> Jl. Dr. Setiabudi No.193, <br> Gegerkalong, Kec. Sukasari, <br> Kota Bandung, <br>Jawa Barat 40153</p>
                    </div>
                </div>
            </div>
            <!-- End Single Footer Widget -->
            ...
            <div class="row">
                <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                    <div class="copyright__inner">
                        <div class="copyright">
                            <p>© <?= date('Y'); ?> <a href="#" target="_blank">Good & Goods</a>
                                All Right Reserved.</p>
                        </div>
                        <ul class="footer__menu">
                            <li><a href="<?= base_url(); ?>">Home</a></li>
                            <li><a href="<?= base_url(); ?>shop">Product</a></li>
